...
<body>
    ...
    <main>
        <div class="text-center">
            <img src="./public/assets/img/pika404.png" alt="Page non trouvée">
            <div>
                <div class="font404">404</div>
                <div class="fs-2">ERREUR</div>
            </div>
            <p class="open-sans-regular fs-1">Pika...Pika?</p>
            <div class="open-sans-light fs-4">
                <p class="open-sans-regular fs-5"> Il semble que Pikachu ne trouve pas cette page.</p>
                <div>Peut-être que vous avez utilisé une attaque de type "Oubli"? </div>
                <div>Retournez à l'accueil pour continuer votre aventure !</div>
            </div>
        </div>
    </main>
